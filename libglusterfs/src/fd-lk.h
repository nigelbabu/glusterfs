...
fd_lk_ctx_t *fd_lk_ctx_ref(fd_lk_ctx_t *lk_ctx);

fd_lk_ctx_t *fd_lk_ctx_create(void);

int fd_lk_insert_and_merge(struct _fd *lk_ctx, int32_t cmd,
                           struct gf_flock *flock);

int fd_lk_ctx_unref(fd_lk_ctx_t *lk_ctx);

gf_boolean_t fd_lk_ctx_empty(fd_lk_ctx_t *lk_ctx);
