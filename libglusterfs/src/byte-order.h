...
static inline uint16_t __swap16(uint16_t x) { return do_swap2(x); }

static inline uint32_t __swap32(uint32_t x) { return do_swap4(x); }

static inline uint64_t __swap64(uint64_t x) { return do_swap8(x); }

static inline uint16_t __noswap16(uint16_t x) { return x; }

static inline uint32_t __noswap32(uint32_t x) { return x; }

static inline uint64_t __noswap64(uint64_t x) { return x; }

static inline uint16_t __byte_order_n16(uint16_t i) {
  uint32_t num = 1;
...
static inline uint32_t __byte_order_n32(uint32_t i) {
  uint32_t num = 1;
...
static inline uint64_t __byte_order_n64(uint64_t i) {
  uint32_t num = 1;
...
static inline uint16_t __byte_order_le16(uint16_t i) {
  uint32_t num = 1;
...
static inline uint32_t __byte_order_le32(uint32_t i) {
  uint32_t num = 1;
...
static inline uint64_t __byte_order_le64(uint64_t i) {
  uint32_t num = 1;
...
static inline uint16_t __byte_order_be16(uint16_t i) {
  uint32_t num = 1;
...
static inline uint32_t __byte_order_be32(uint32_t i) {
  uint32_t num = 1;
...
static inline uint64_t __byte_order_be64(uint64_t i) {
  uint32_t num = 1;
