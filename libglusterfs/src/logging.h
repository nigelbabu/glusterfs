...
int _gf_msg(const char *domain, const char *file, const char *function,
...
int _gf_msg_nomem(const char *domain, const char *file, const char *function,
...
#define gf_msg(dom, level, errnum, msgid, fmt...)                              \
  do {                                                                         \
    _gf_msg(dom, __FILE__, __FUNCTION__, __LINE__, level, errnum, 0, msgid,    \
            ##fmt);                                                            \
  } while (0)
...
#define gf_msg_callingfn(dom, level, errnum, msgid, fmt...)                    \
  do {                                                                         \
    _gf_msg(dom, __FILE__, __FUNCTION__, __LINE__, level, errnum, 1, msgid,    \
            ##fmt);                                                            \
  } while (0)
...
#define gf_msg_debug(dom, errnum, fmt...)                                      \
  do {                                                                         \
    _gf_msg(dom, __FILE__, __FUNCTION__, __LINE__, GF_LOG_DEBUG, errnum, 0, 0, \
            ##fmt);                                                            \
  } while (0)

#define gf_msg_trace(dom, errnum, fmt...)                                      \
  do {                                                                         \
    _gf_msg(dom, __FILE__, __FUNCTION__, __LINE__, GF_LOG_TRACE, errnum, 0, 0, \
            ##fmt);                                                            \
  } while (0)
...
#define gf_log_callingfn(dom, level, fmt...)                                   \
  do {                                                                         \
    FMT_WARN(fmt);                                                             \
    _gf_log_callingfn(dom, __FILE__, __FUNCTION__, __LINE__, level, ##fmt);    \
  } while (0)
...
int _gf_slog(const char *domain, const char *file, const char *function,
             int line, gf_loglevel_t level, const char *event, ...);

int _gf_smsg(const char *domain, const char *file, const char *function,
             int32_t line, gf_loglevel_t level, int errnum, int trace,
...
#define gf_smsg(dom, level, errnum, msgid, event...)                           \
  do {                                                                         \
    _gf_smsg(dom, __FILE__, __FUNCTION__, __LINE__, level, errnum, 0, msgid,   \
             ##event);                                                         \
  } while (0)
