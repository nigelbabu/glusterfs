...
void gfdb_query_record_free(gfdb_query_record_t *gfdb_query_record);
typedef void (*gfdb_query_record_free_t)(gfdb_query_record_t *);

/* Function to write query record to file */
int gfdb_write_query_record(int fd, gfdb_query_record_t *gfdb_query_record);
 ...
 * Return 0 when EOF.
 * */
int gfdb_read_query_record(int fd, gfdb_query_record_t **gfdb_query_record);
