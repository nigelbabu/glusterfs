...
int sys_utimensat(int dirfd, const char *filename,
                  const struct timespec times[2], int flags);
#endif

int sys_futimes(int fd, const struct timeval times[2]);
...
void gf_add_prefix(const char *ns, const char *key, char **newkey);

void gf_remove_prefix(const char *ns, const char *key, char **newkey);
