...
static inline void *__gf_default_malloc(size_t size) {
  void *ptr = NULL;
...
static inline void *__gf_default_calloc(int cnt, size_t size) {
  void *ptr = NULL;
...
static inline void *__gf_default_realloc(void *oldptr, size_t size) {
  void *ptr = NULL;
...
static inline char *gf_strndup(const char *src, size_t len) {
  char *dup_str = NULL;
...
static inline char *gf_strdup(const char *src) {
  if (!src)
    return NULL;
...
static inline void *gf_memdup(const void *src, size_t size) {
  void *dup_mem = NULL;
...
struct mem_pool *mem_pool_new_fn(glusterfs_ctx_t *ctx,
                                 unsigned long sizeof_type, unsigned long count,
                                 char *name);
