...
static inline call_frame_t *syncop_create_frame(xlator_t *this) {
  call_frame_t *frame = NULL;
  int ngrps = -1;
...
int syncop_fsync(xlator_t *subvol, fd_t *fd, int dataonly, struct iatt *preiatt,
...
int syncop_fsyncdir(xlator_t *subvol, fd_t *fd, int datasync, dict_t *xdata_in,
                    dict_t **xdata_out);

int syncop_access(xlator_t *subvol, loc_t *loc, int32_t mask, dict_t *xdata_in,
                  dict_t **xdata_out);
...
int syncop_fxattrop(xlator_t *subvol, fd_t *fd, gf_xattrop_flags_t flags,
                    dict_t *dict, dict_t *xdata_in, dict_t **dict_out,
                    dict_t **xdata_out);
...
int syncop_getactivelk(xlator_t *subvol, loc_t *loc,
                       lock_migration_info_t *locklist, dict_t *xdata_in,
                       dict_t **xdata_out);

int syncop_setactivelk_cbk(call_frame_t *frame, void *cookie, xlator_t *this,
                           int32_t op_ret, int32_t op_errno, dict_t *xdata);

int syncop_setactivelk(xlator_t *subvol, loc_t *loc,
                       lock_migration_info_t *locklist, dict_t *xdata_in,
                       dict_t **xdata_out);

int syncop_put(xlator_t *subvol, loc_t *loc, mode_t mode, mode_t umask,
...
int syncop_icreate(xlator_t *subvol, loc_t *loc, mode_t mode,
                   dict_t *xdata_out);

int syncop_namelink(xlator_t *subvol, loc_t *loc, dict_t *xdata_out);

int syncop_entrylk(xlator_t *subvol, const char *volume, loc_t *loc,
