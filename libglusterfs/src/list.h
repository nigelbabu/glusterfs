...
static inline void list_add_order(struct list_head *new, struct list_head *head,
...
static inline void __list_append(struct list_head *list,
                                 struct list_head *head) {
...
static inline void list_append(struct list_head *list, struct list_head *head) {
  if (list_empty(list))
    return;
...
static inline void list_append_init(struct list_head *list,
                                    struct list_head *head) {
  if (list_empty(list))
    return;
