...
compound_args_t *compound_fop_alloc(int length, glusterfs_compound_fop_t fop,
                                    dict_t *xdata);

void compound_args_cleanup(compound_args_t *args);

void compound_args_cbk_cleanup(compound_args_cbk_t *args_cbk);

compound_args_cbk_t *compound_args_cbk_alloc(int length, dict_t *xdata);
