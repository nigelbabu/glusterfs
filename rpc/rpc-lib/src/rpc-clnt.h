...
struct rpc_clnt *rpc_clnt_new(dict_t *options, xlator_t *owner, char *name,
...
void rpc_clnt_disable(struct rpc_clnt *rpc);

void rpc_clnt_disconnect(struct rpc_clnt *rpc);

char rpc_clnt_is_disabled(struct rpc_clnt *rpc);

int rpc_clnt_mgmt_pmap_signout(glusterfs_ctx_t *ctx, char *brick_name);
