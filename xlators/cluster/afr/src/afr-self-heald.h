...
int afr_selfheal_childup(xlator_t *this, int subvol);

int afr_selfheal_daemon_init(xlator_t *this);

int afr_xl_op(xlator_t *this, dict_t *input, dict_t *output);

int afr_shd_gfid_to_path(xlator_t *this, xlator_t *subvol, uuid_t gfid,
                         char **path_p);

int afr_shd_index_purge(xlator_t *subvol, inode_t *inode, char *name,
                        ia_type_t type);
