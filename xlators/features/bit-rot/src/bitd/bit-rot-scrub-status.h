...
void br_inc_unsigned_file_count(br_scrub_stats_t *scrub_stat);
void br_inc_scrubbed_file(br_scrub_stats_t *scrub_stat);
void br_update_scrub_start_time(br_scrub_stats_t *scrub_stat,
                                struct timeval *tv);
void br_update_scrub_finish_time(br_scrub_stats_t *scrub_stat, char *timestr,
                                 struct timeval *tv);
